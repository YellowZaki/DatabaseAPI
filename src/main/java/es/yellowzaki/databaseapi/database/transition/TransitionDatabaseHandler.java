...
public class TransitionDatabaseHandler<T> extends AbstractDatabaseHandler<T> {
    ...
    /* (non-Javadoc)
     * @see es.yellowzaki.databaseapi.database.AbstractDatabaseHandler#loadObjects()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see es.yellowzaki.databaseapi.database.AbstractDatabaseHandler#loadObject(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see es.yellowzaki.databaseapi.database.AbstractDatabaseHandler#objectExists(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see es.yellowzaki.databaseapi.database.AbstractDatabaseHandler#saveObject(java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see es.yellowzaki.databaseapi.database.AbstractDatabaseHandler#deleteObject(java.lang.Object)
     */
    @Override
