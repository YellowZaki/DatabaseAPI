...
public class Database<T> {
     ...
     */
    public Database(DatabaseSettings settings, Class<T> type)  {
        this.logger = settings.getPlugin().getLogger();
        DatabaseSetup databaseSetup = DatabaseSetup.getDatabase(settings);
        handler = databaseSetup.getHandler(type, settings);
