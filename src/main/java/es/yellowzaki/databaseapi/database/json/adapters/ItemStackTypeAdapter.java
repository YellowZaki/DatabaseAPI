package es.yellowzaki.databaseapi.database.json.adapters;
...
public class ItemStackTypeAdapter extends TypeAdapter<ItemStack> {
    ...
    public ItemStack read(JsonReader reader) throws IOException {
        ...
        if (n.contains("type:")) {
            ...
            if (m == null) {
                DatabaseLogger.logWarning("Unknown material: " + type);
        ...
        try {
            ...
            DatabaseLogger.logError("Cannot load ItemStack serialized as " + n);
            return new ItemStack(Material.AIR);
        }
    }
