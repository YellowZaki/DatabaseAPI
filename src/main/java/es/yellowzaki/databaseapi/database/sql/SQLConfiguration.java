...
public class SQLConfiguration {
    ...
    public <T> SQLConfiguration(JavaPlugin plugin, Class<T> type, DatabaseSettings settings) {
        // Set the table name
        oldTableName = settings.getDatabasePrefix() + type.getCanonicalName();
        this.tableName = settings.getDatabasePrefix() +
        ...
        renameTable("SELECT Count(*) INTO @exists " +
                ...
                "WHERE table_schema = '" + settings.getDatabaseName() + "' " +
